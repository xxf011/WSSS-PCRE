...
class DenseCRF(object):
    ...
    def __repr__(self):
        return (f"DenseCRF(iter_max={self.iter_max}, pos_xy_std={self.pos_xy_std}, "
                f"pos_w={self.pos_w}, bi_xy_std={self.bi_xy_std}, "
                f"bi_rgb_std={self.bi_rgb_std}, bi_w={self.bi_w})")
