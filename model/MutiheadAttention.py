...
def multi_head_attention_forward(query: Tensor,
    ...
    ret_attn_output_weights = attn_output_weights
    attn_output_weights = softmax(
    ...
    if need_weights:
        ...
        ret_attn_output_weights = ret_attn_output_weights.view(bsz, num_heads, tgt_len, src_len)
        return attn_output, ret_attn_output_weights
    else:
